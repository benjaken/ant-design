...
- Icon 现在支持旋转动画。
- Tabs 现在可以禁用切换动画。
- 新增西班牙语的 l10n 支持。@Danjavia
- 更新俄语的 l10n 文案。@plandem
...
- 修复 DatePicker 与 TimePicker 样式冲突问题。[#3312](https://github.com/ant-design/ant-design/issues/3312) [#3307](https://github.com/ant-design/ant-design/issues/3307)
- DatePicker
